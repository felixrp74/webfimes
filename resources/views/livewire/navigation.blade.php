...
<nav class="bg-gray-800" x-data="{ open: false }">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:block sm:ml-6" >
            <div class="flex space-x-4">
              ...
              {{-- <a href="{{route('posts.index')}}" class="text-white px-3 py-2 rounded-md text-sm font-medium">Publicaciones</a> --}}
              {{-- <a href="{{route('mecanica.inicio')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Mecánica Electrica</a>
              <a href="{{route('electronica.inicio')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Electrónica</a>
              <a href="{{route('sistemas.inicio')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Sistemas</a> --}}
            ...
            <div class="ml-3 relative" x-data="{ open: false }">
              <div>
                <button x-on:click="open = true" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-haspopup="true">
                  ...
                  <img class="h-8 w-8 rounded-full" src="{{ auth()->user()->profile_photo_url }}" alt="UR">
                </button>
              </div>
              <!--
              ...
              <div x-show="open" x-on:click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                ...
                <a href="{{route('responsable.inicio')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Responsables</a>
    ...
    <div class="sm:hidden" x-show="open" x-on:click.away="open = false" >
      <div class="px-2 pt-2 pb-3 space-y-1">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        {{-- <a href="{{route('/')}}" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Publicaciones</a> --}}
